...
export default function WorldClock() {
  ...
  if (!mounted) {
    return (
      <div className="w-full max-w-xs mx-auto opacity-0">
  ...
  return (
    <div className="w-full max-w-xs mx-auto">
      <div className="rounded-2xl border border-white/[0.03] backdrop-blur-xl bg-white/[0.02] p-6 transition-all duration-300 hover:border-cyan-400/15 hover:shadow-[0_0_40px_-10px_rgba(0,229,255,0.08)]">
        ...
        <div ref={dropRef} className="relative">
          ...
          {/* Dropdown */}
          {dropdownOpen && (
            <div className="absolute bottom-full left-0 right-0 mb-2 max-h-52 overflow-y-auto rounded-xl border border-white/[0.06] bg-[#0a0a1a]/95 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.6)] z-50 custom-scrollbar">
              {timezones.map((tz) => (
                <button
                  key={tz.value}
                  onClick={() => {
