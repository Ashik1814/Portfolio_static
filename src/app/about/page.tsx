  ...
  return (
    <main className="min-h-screen pt-24 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        {/* ── Profile Card ────────────────────────────────────────────── */}
        <div className="rounded-2xl border border-white/[0.03] p-8 backdrop-blur-xl md:p-10">
        ...
        <div className="mt-12 grid grid-cols-2 gap-6 sm:grid-cols-4">
          {stats.map((stat) => {
            ...
            return (
              <div
                key={stat.label}
                className="rounded-2xl border border-white/[0.03] p-6 text-center backdrop-blur-xl"
              >
          ...
          <div className="relative space-y-6">
            ...
            {experience.map((entry, index) => (
              <div key={index} className="relative flex gap-5">
                ...
                {/* Card */}
                <div className="flex-1 rounded-2xl border border-white/[0.03] border-l-2 border-l-cyan-500 p-6">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            {interests.map((interest) => {
              ...
              return (
                <div
                  key={interest.label}
                  className="flex items-center gap-4 rounded-2xl border border-white/[0.03] p-4 backdrop-blur-xl"
                >
